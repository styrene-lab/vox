...
## [0.1.4](https://github.com/styrene-lab/vox/releases/tag/vox-slack-v0.1.4) - 2026-06-12
...
- *(connectors)* cover permissive token file degradation
- *(slack)* satisfy clippy warnings
