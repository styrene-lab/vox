...
## [0.1.6](https://github.com/styrene-lab/vox/compare/vox-v0.1.5...vox-v0.1.6) - 2026-06-12
...
- *(vox)* handle startup errors without panic
- *(vox)* avoid panic registering shutdown signal
- *(vox)* avoid panics serializing tool responses
- *(vox)* remove disabled lxmf cfg warning
